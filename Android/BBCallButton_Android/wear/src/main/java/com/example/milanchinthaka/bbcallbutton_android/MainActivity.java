...
//            btnCancel.setVisibility(View.GONE);
    ...
    public void addNewCallLayout(final Call call){
        ...
        final TextView btnAccept = (Button) rowView.findViewById(R.id.btnAccept);
//        fin
// al TextView btnCancel = (Button) rowView.findViewById(R.id.btnCancelMain);
...
//                Database.getInstance().initDatabase();
                ...
                nameTxt = (TextView) stub.findViewById(R.id.txtName);

                newCallLayout = (LinearLayout) stub.findViewById(R.id.newCallLayouot);
                ...
                final ImageButton powerBtn = (ImageButton) stub.findViewById(R.id.onoffBtn);
...
//        notificationManager.cancel(Notifications.notificationID);
        ...
        alarmManager.setRepeating(AlarmManager.RTC_WAKEUP, now.getTimeInMillis(), 20000, intentExecuted);
    }
}
